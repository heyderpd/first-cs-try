...
namespace VideoPlayerController
{
    ...
    public static class AudioManager
    {
        ...
        public static void setMasterCaptureVolume(float level)
        {
            Guid guid = Guid.Empty;
            IMMDeviceEnumerator deviceEnumerator = null;
            IMMDevice speakers = null;
        ...
        #region Special Volume Manipulation
        ...
        {
            // EDataFlow.eRender
            ManipuleVolume(pid, EDataFlow.eRender, true, level, 100);
        }

        private static float ManipuleVolume(int pid, EDataFlow _EDataFlow, Boolean setVol, float level, float all)
        {
            Guid guid = Guid.Empty;
            IMMDeviceEnumerator deviceEnumerator = null;
            IAudioSessionEnumerator sessionEnumerator = null;
            ...
            try
            {
                // get the speakers (1st render + multimedia) device
                deviceEnumerator = (IMMDeviceEnumerator)(new MMDeviceEnumerator());
                deviceEnumerator.GetDefaultAudioEndpoint(_EDataFlow, ERole.eMultimedia, out speakers);
